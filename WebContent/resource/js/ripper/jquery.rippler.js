	...
	if ($.browser.msie && ($.browser.version < 9)) {
		...
		var methods = {
			...
			template : function(options) {
				...
				var svgElement = '<svg class="' + options.effectClass + " " + svgElementClass + '" xmlns="http://www.w3.org/2000/svg" viewBox="' + options.effectSize / 2 + " " + options.effectSize
						/ 2 + " " + options.effectSize + " " + options.effectSize + '">' + circle + "</svg>";
